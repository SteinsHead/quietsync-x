...
- [x] 同一个 Manifest V3 ZIP 可以用于首轮提交
- [x] 介绍长度超过 Edge 要求的 250 个字符
- [x] 可以复用图标、截图、推广图、隐私政策和审核说明
- [ ] Partner Center 开发者账号已准备
- [ ] 发布者本人确认并提交审核
